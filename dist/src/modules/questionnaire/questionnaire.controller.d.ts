...
export declare class QuestionnaireController {
    ...
    findAll(query: FilterQuestionnaireResponseDto): Promise<{
        data: {
            id: string;
            date: Date;
            totalScore: number;
    ...
    create(dto: CreateResponseDto): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        totalScore: number;
    ...
    getByParticipant(id: string): Promise<({
        healthProfessional: {
            user: {
                fullName: string;
            };
    ...
    getOneResponse(id: string): Promise<({
        participant: {
            user: {
                fullName: string;
            };
